...
class AndroidControlsSubState extends FlxSubState
{
	...
	override function create()
	{
		...
		exitButton.label.setFormat(Assets.getFont('assets/fonts/var.ttf').fontName, 16, FlxColor.WHITE, CENTER, true);
		...
		resetButton.label.setFormat(Assets.getFont('assets/fonts/vcr.ttf').fontName, 16, FlxColor.WHITE, CENTER, true);
		...
		inputvari.setFormat(Assets.getFont('assets/fonts/vcr.ttf').fontName, 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		...
		rightPozition.setFormat(Assets.getFont('assets/fonts/vcr.ttf').fontName, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		rightPozition.borderSize = 2.4;
		add(rightPozition);

		leftPozition = new FlxText(10, FlxG.height - 44, 0, '', 16);
		leftPozition.setFormat(Assets.getFont('assets/fonts/vcr.ttf').fontName, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		leftPozition.borderSize = 2.4;
		add(leftPozition);

		downPozition = new FlxText(10, FlxG.height - 64, 0, '', 16);
		downPozition.setFormat(Assets.getFont('assets/fonts/vcr.ttf').fontName, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		downPozition.borderSize = 2.4;
		add(downPozition);

		upPozition = new FlxText(10, FlxG.height - 84, 0, '', 16);
		upPozition.setFormat(Assets.getFont('assets/fonts/vcr.ttf').fontName, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
